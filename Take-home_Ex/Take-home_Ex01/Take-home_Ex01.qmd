...
```{r}
pacman::p_load(tidyverse, sf, tmap, httr, readxl, dplyr, stringr, rvest, knitr, spatstat, terra, raster, sparr, tidyr, kableExtra)
```
...
+=====================+=======================================================+=========================+==========================================================+==================================================================================================================================================================================+
| 471                 | Retail Sale in Non-Specialised Stores                 | **Retail**              | 4710: Retail Sale in Non-Specialised Stores              | 47101: Supermarkets and hypermarkets                                                                                                                                             |
|                     |                                                       |                         |                                                          |                                                                                                                                                                                  |
...
+---------------------+-------------------------------------------------------+-------------------------+----------------------------------------------------------+----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+
| 561                 | Restaurants, Cafes, Food Courts, Food Kiosks And Bars | **Food & Beverage**     | 5611: Restaurants and Cafes                              | 56111: Restaurants                                                                                                                                                               |
|                     |                                                       |                         |                                                          |                                                                                                                                                                                  |
|                     |                                                       |                         | 5612: Fast Food Outlets, Food Courts and Food Kiosks     | 56112: Cafes                                                                                                                                                                     |
|                     |                                                       |                         |                                                          |                                                                                                                                                                                  |
|                     |                                                       |                         | 5613: Pubs                                               | --                                                                                                                                                                               |
|                     |                                                       |                         |                                                          |                                                                                                                                                                                  |
|                     |                                                       |                         | 5614: Stalls Selling Cooked Food and Prepared Drinks     | 56121: Fast food outlets                                                                                                                                                         |
|                     |                                                       |                         |                                                          |                                                                                                                                                                                  |
...
+---------------------+-------------------------------------------------------+-------------------------+----------------------------------------------------------+----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+
| 681                 | Real Estate Activities With Own Or Leased Property    | **Real Estate**         | 6810: Real Estate Activities With Own Or Leased Property | 68101: Real estate developers                                                                                                                                                    |
|                     |                                                       |                         |                                                          |                                                                                                                                                                                  |
...
ggplot() +
  geom_sf(data = mpsz, fill = "lightgray", color = "white") +
...
## CORE SPATIAL ANALYSIS - LAYER 1: REGISTRATION INTENT ANALYSIS
...
```{r}
# Calculate KDE using spatstat (Prof's approach)
...
### Ripley's K-Function: Clustering Intensity

```
# Calculate K-functions for each business type
k_restaurants_all <- Kest(ppp_restaurants_all, correction = "Ripley")
k_retail_all <- Kest(ppp_retail_all, correction = "Ripley")
k_realestate_all <- Kest(ppp_realestate_all, correction = "Ripley")

# Calculate L-functions (normalized K-functions)
l_restaurants_all <- Lest(ppp_restaurants_all, correction = "Ripley")
l_retail_all <- Lest(ppp_retail_all, correction = "Ripley")
l_realestate_all <- Lest(ppp_realestate_all, correction = "Ripley")

# Plot K-functions with confidence envelopes
k_env_restaurants <- envelope(ppp_restaurants_all, Kest, nsim = 99, correction = "Ripley")
k_env_retail <- envelope(ppp_retail_all, Kest, nsim = 99, correction = "Ripley")
k_env_realestate <- envelope(ppp_realestate_all, Kest, nsim = 99, correction = "Ripley")

# Plot results
par(mfrow = c(1, 3))
plot(k_env_restaurants, main = "K-function: Restaurants (561)")
plot(k_env_retail, main = "K-function: Retail (471)")
plot(k_env_realestate, main = "K-function: Real Estate (681)")
par(mfrow = c(1, 1))
```

### Cross K-Function

### Nearest Neighbor Analysis: Clark-Evans tests and distance distributions
